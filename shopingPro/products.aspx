<%@ Page Title="" Language="C#" MasterPageFile="~/anon.Master" AutoEventWireup="true" CodeBehind="products.aspx.cs" Inherits="shopingPro.products" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="allcontain">
        <div class="feturedsection">
            <h1 class="text-center"><span class="bdots" aria-autocomplete="inline">&bullet;</span><span class="carstxt">C A R S</span>&bullet;</h1>
        </div>
