<%@ Page Title="" Language="C#" MasterPageFile="~/anon.Master" AutoEventWireup="true" CodeBehind="offers.aspx.cs" Inherits="shopingPro.offers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="allcontain">
        <div class="feturedsection">
            <h1 class="text-center"><span class="bdots" aria-autocomplete="inline">&bullet;</span>C A R S<span class="carstxt">W I T H <span class="carstxt"> O FF E R S</span>&bullet;</h1>
        </div>
